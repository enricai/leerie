{
  "preprocess": {
    ...
    "sha256": "ead3787610cf884cf434622bdaabf85992b0fc408122f58716dcf2c98ec0b2ea",
    "lines": 17139,
    "bytes": 803993,
  ...
  "lex": {
    ...
    "comment_chars": 181215,
    "string_literal_count": 5548,
    "env_vars": [
      "LEERIE_CAPTURE_DEPS",
      "LEERIE_CLARIFY",
  ...
  "functions": [
    ...
    },
    {
      ...
      "doc": "Extract all distinct Bash commands from worker logs for dep_capture input."
    },
    {
    ...
    },
    {
      ...
      "span": 130,
      "decorators": [],
      "signature": "(repo_root: Path, st: object, caps: dict | None = None, models: dict[str, str] | None = None, efforts: dict[str, str | None] | None = None)",
      "returns": "None",
      "doc": "Invoke the dep_capture LLM worker and write deps to .leerie/config.toml."
    },
    {
      ...
      "returns": "None",
      "doc": "Scan prior runs for uncaptured logs and run dep_capture over them."
    },
    {
      ...
      "returns": "None",
      "doc": "Host-side recapture entrypoint (DESIGN \u00a76\u00bd)."
    },
    {
...
=== orchestrator/leerie.py sha=ead3787610cf ===
lines=17139 tokens=91882 ast_nodes=69021 functions=263 classes=8 constants=168
