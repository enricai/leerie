{
  "preprocess": {
    ...
    "sha256": "bb65d75d976260ee9e0fc55a2b751e9729f9bc82a87a061432714fd2c01fe759",
    "lines": 19826,
    "bytes": 938413,
  ...
  "lex": {
    ...
    "comment_chars": 215809,
    "string_literal_count": 6407,
    "env_vars": [
      "LEERIE_AWS_PROFILE",
      "LEERIE_AWS_REGION",
      "LEERIE_CAPTURE_DEPS",
  ...
  "functions": [
    ...
    {
      "name": "_run_status_for",
      "qualname": "_run_status_for",
      "async": false,
      "lineno": 2744,
      "end_lineno": 2761,
      "span": 18,
      ...
      "returns": "str",
      "doc": "Derived status for a `discover_runs` row."
    },
    {
      "name": "_run_recency_key",
      "qualname": "_run_recency_key",
      "async": false,
      "lineno": 2764,
      "end_lineno": 2779,
      "span": 16,
      ...
      "doc": "Sort key for picking the most recent run, newest last."
    },
    {
      "name": "resolve_run_id",
      ...
      "span": 60,
      "decorators": [],
      "signature": "(leerie_root: Path, cli_run_id: str | None, *, resumable_only: bool = False)",
      "returns": "str",
      "doc": "Pick the run_id to operate on."
    },
    {
