{
  "preprocess": {
    ...
    "sha256": "2ba3a46c05009e60d5bdda662ff67898dff2febe0d9efaf915ea2b4db749b879",
    "lines": 18560,
    "bytes": 869050,
  ...
  "lex": {
    ...
    "comment_chars": 194918,
    "string_literal_count": 6102,
    "env_vars": [
      "LEERIE_CAPTURE_DEPS",
      "LEERIE_CLARIFY",
  ...
  "functions": [
    ...
    },
    {
      ...
      "span": 145,
      "decorators": [],
      "signature": "(subtask: dict, depth: int, st: 'State', caps: dict, models: dict[str, str], efforts: dict[str, str | None], repo_root: Path, *, _parent_score: float | None = None, _noprogress_count: int = 0)",
      "returns": "list[dict]",
...
=== orchestrator/leerie.py sha=2ba3a46c0500 ===
lines=18560 tokens=100041 ast_nodes=75296 functions=287 classes=8 constants=173
