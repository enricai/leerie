...
def _run_claude_p(leerie, st, envelope, monkeypatch):
...
def test_single_call_writes_one_ndjson_line(leerie, tmp_path, monkeypatch):
    ...
    _run_claude_p(leerie, st, _GOOD_ENVELOPE, monkeypatch)
...
def test_single_call_field_values(leerie, tmp_path, monkeypatch):
...
def test_two_calls_append_two_lines(leerie, tmp_path, monkeypatch):
...
def test_failed_call_still_writes_record(leerie, tmp_path, monkeypatch):
...
def test_capture_file_at_run_dir_calls_ndjson(leerie, tmp_path, monkeypatch):
